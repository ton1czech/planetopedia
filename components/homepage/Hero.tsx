  ...
  return (
    <Container className='grid h-screen place-content-center'>
      <div className='absolute left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] z-10 pointer-events-none'>
        ...
        <p
          className={`${caramel.className} text-right text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl text-gold drop-shadow-sm -mt-3 md:-mt-5`}
        >
          More than an agency
        </p>
      </div>
      ...
      <Earth />
      {/* <div className='absolute top-0 left-0 w-screen h-screen -z-10 earth-gradient' /> */}
    </Container>
  )
}
